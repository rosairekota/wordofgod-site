...
const JournalCard:React.FC<Props> = ({imageUrl,journalDate,createdBy,title,description}) => {
  return (
    <div className="bg-white drop-shadow-xl rounded-md cursor-pointer">
     <div className="overflow-hidden">
       <Image src={imageUrl} alt="test" className="cover rounded-t-md transition duration-300 ease-out hover:scale-105" />
     </div>
      <div>
